...
function ValidateInputs() {
    ...
    f.validate({
        ...
        messages: {
            ...
            thirdSide: {
                required: "Third side of the triangle is required"
            }
        }
    });
...
function SolveTriangle() {
    ...
    $("#triangleLink").text("http://www.wikipedia.org/wiki/" + triangleType + "_triangle");
    $("#triangleLink").attr("href", "http://www.wikipedia.org/wiki/" + triangleType + "_triangle");
